...
def initialize():
    global data_columns
    global __model
    with open("house_price_one_hot/columns.json", 'r') as f:
        data_columns = json.load(f)

    global __model
    with open("house_price_one_hot/price.pickle", 'rb') as f:
...
def estimate_onehot(request):
    ...
    if request.method=="GET":
        ...
        return render(request,'house_price_one_hot/houseprice.html',{'data':data})
    else:
